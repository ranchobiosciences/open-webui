								...
								<div class="self-end flex space-x-1 mr-1 shrink-0 gap-[0.5px]">
									<div class="flex min-w-0 max-w-[10rem] items-center sm:max-w-[13rem]">
										<ModelSelector
											...
											placement="auto"
											align="end"
											triggerClassName="items-center gap-1.5 rounded-lg pl-2 pr-1.5 py-1 text-[13px] font-normal text-black transition-colors duration-100 hover:bg-gray-50/40 hover:text-black dark:text-white dark:hover:bg-gray-800/40 dark:hover:text-white"
										/>
									</div>
